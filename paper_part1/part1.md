...
идентификации подов](https://kubernetes.io/docs/concepts/services-networking/)) и вместо
...
сервисами запрещены при помощи политик.](Picture_2.gif)
...
Для более подробной информации о сетевой инфраструктуре Kubernetes вы можете ознакомиться со [справочником Kubernetes](https://kubernetes.io/docs/concepts/overview/components/#networking-components) 
...
1[Рисунок 18. Три типа моделей по обмену и сбору данных.](Image18.png)
...
![Таблица 3. Сравнение инструментов наблюдаемости в k8s](Table3.png)
*Таблица 3. Сравнение инструментов наблюдаемости в k8s*
